...
# your code goes here
np.count_nonzero(calorie_stats_sorted > 60)/np.count_nonzero(calorie_stats_sorted >0)*100
...
# 96% of the other copanies products have the Calories Higher than CunchieMunch. Most of the products have the clories minimum 87
# and 125. That is why our product is very suited for all aged prople, and have healthy nutrition for all age groups
